...
var featurit_1 = require("./featurit");
var FeaturitAnalyticsService = /** @class */ (function () {
        ...
        this.timer = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        analyticsBucket = this.storage.get(featurit_1.STORAGE_KEY.ANALYTICS);
                        if (!analyticsBucket) {
                            return [2 /*return*/];
                        }
                    ...
                    case 1:
                        _a.sent();
                        this.storage.remove(featurit_1.STORAGE_KEY.ANALYTICS);
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
    ...
    FeaturitAnalyticsService.prototype.registerFeatureFlagRequest = function (featureName, featureFlagValue, currentTime) {
        ...
        var analyticsBucket = (_a = this.storage.get(featurit_1.STORAGE_KEY.ANALYTICS)) !== null && _a !== void 0 ? _a : this.createAnalyticsBucket(currentTime);
        ...
        if (typeof analyticsBucket["reqs"][hourKey][flagNameKey][flagVersionKey] ==
            "undefined") {
        ...
        this.storage.set(featurit_1.STORAGE_KEY.ANALYTICS, analyticsBucket);
    };
