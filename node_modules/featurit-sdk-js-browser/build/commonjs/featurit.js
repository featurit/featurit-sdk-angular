...
var Featurit = /** @class */ (function (_super) {
    ...
    function Featurit(_a) {
        ...
        _this.refreshIntervalMinutes =
            refreshIntervalMinutes !== null && refreshIntervalMinutes !== void 0 ? refreshIntervalMinutes : DEFAULT_REFRESH_INTERVAL_MINUTES;
        _this.apiClient = apiClient;
        _this.apiBaseUrl = "https://".concat(_this.tenantIdentifier, ".featurit.com/api/v1/").concat(_this.frontendApiKey);
        _this.isAnalyticsEnabled = enableAnalytics !== null && enableAnalytics !== void 0 ? enableAnalytics : false;
        _this.sendAnalyticsIntervalMinutes =
            sendAnalyticsIntervalMinutes !== null && sendAnalyticsIntervalMinutes !== void 0 ? sendAnalyticsIntervalMinutes : DEFAULT_SEND_ANALYTICS_INTERVAL_MINUTES;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        data = _a.sent();
                        if (JSON.stringify(Object.fromEntries(this.featureFlags)) ==
    ...
    Featurit.prototype.setFeaturitUserContextProvider = function (featuritUserContext, featuritUserContextProvider) {
        ...
        this.featuritUserContextProvider =
            featuritUserContextProvider !== null && featuritUserContextProvider !== void 0 ? featuritUserContextProvider : new default_featurit_user_context_provider_1.DefaultFeaturitUserContextProvider();
    };
...
//# sourceMappingURL=featurit.js.map